  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo e(route('admin.category.index')); ?>"><img src="logo.png" style="max-height: 50px; max-width: 50px;">&nbsp;&nbsp;<span class="text-white">QUẢN LÝ TRUYỆN</span></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Truyện">
          <a class="nav-link" href="<?php echo e(route('admin.story.index')); ?>">
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">Chọn Đăng Xuất nếu bạn đã chắc chắn.</div>
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo e(route('logout')); ?>">Đăng xuất</a>
        </div>
      </div>
    </div>
</div>