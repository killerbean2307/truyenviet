...
<div class="container-fluid">
    ...
    <div>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="<?php echo e(route('admin.author.index')); ?>">Tác giả</a></li>
      </ol>
    </div>
      ...
      <?php if(App\Author::all()->count()): ?>
        <div class="card-footer small text-muted">Cập nhật vào lúc <?php echo e(App\Author::orderBy('updated_at','desc')->pluck('updated_at')->first()->format('H:i d-m-Y')); ?></div>
      <?php endif; ?>        
      </div>
</div>
<!-- add modal -->
